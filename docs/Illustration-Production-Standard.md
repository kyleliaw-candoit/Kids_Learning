# Illustration Production Standard
...
Backgrounds should be simpler and less visually assertive than the main characters and story-critical objects.

Use these controls to keep the hierarchy clear:

- fewer secondary props;
- broader, simpler background shapes;
- softer edges and lower contrast away from the focal action;
- less texture and color variation in distant areas;
- stronger line clarity, contrast, and color separation on the characters and key objects;
...
Remy and recurring characters should remain iconic, consistent, and reusable.

- Preserve the canonical markings, costume colors, proportions, and signature props.
- Keep expressions slightly exaggerated and immediately readable.
- Use hand-drawn linework and light texture, but do not render individual fur strands or realistic anatomy.
- Remy should feel playful, goofy, curious, and capable of being confused.
- Character details must survive reduction to worksheet size.

The canonical Remy reference remains the identity source of truth. The approved production rendering adds hand-drawn warmth and modest dimensionality without redesigning the character.

## Story art and functional graphics

Treat story illustrations and puzzle diagrams as separate systems.
...
Maps, clocks, timelines, route plans, logic grids, tables, and clue diagrams must be constructed for accuracy first.

Functional graphics should:

- match every written fact exactly;
- make problem-critical information prominent;
- use recognizable objects rather than abstract or unexplained icons;
- use readable labels and sufficient contrast;
- retain an illustrated-adventure feeling through restrained color, line character, or framing;
- never allow decorative texture to obscure a relationship, number, route, or constraint.

Generated story art must not be used as the sole source for exact puzzle information when a precisely constructed diagram is needed.
...
6. Apply the complete rendered-page QA gate before delivery.
